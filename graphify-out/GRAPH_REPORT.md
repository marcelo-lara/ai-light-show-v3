...
## Corpus Check
- 48 files · ~19,018 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 477 nodes · 541 edges · 73 communities (53 shown, 20 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 80 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e9c6940a`
...
1. `UI Specification: AI Light Show V3 Frontend` - 16 edges
2. `Development Handoff Stories` - 15 edges
3. `FrameRenderer` - 14 edges
4. `WaveShader` - 14 edges
5. `RadialPulseShader` - 14 edges
6. `BaseLayer` - 13 edges
7. `SpectroidChaseShader` - 12 edges
8. `RaindropsShader` - 12 edges
9. `Glossary` - 12 edges
10. `PresetSchema` - 9 edges
...
Cohesion: 0.08
Nodes (22): find_canvas_for_song(), GenerateRequest, list_presets(), load_song(), run_generation(), test_epic_01_validation(), BaseModel, AudioAnalyzer (+14 more)
...
Cohesion: 0.1
Nodes (13): fetchFrames(), FrameData, handleLoad(), initWavesurfer(), ModulatorConfig, PresetParameter, PresetSummary, SceneSchema (+5 more)
...
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Dependencies, Epic 08: Preview Console, First Iteration, Scope, Story, Why This Matters

### Community 16 - "Community 16"
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Dependencies, Epic 01: Render Contract, First Iteration, Scope, Story, Why This Matters
...
Cohesion: 0.5
Nodes (4): Backend Track, Epic 11: Raindrops Shader, Frontend Track, Validation Track

### Community 35 - "Community 35"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 10: Fixture Mapping And Export, Frontend Track, Validation Track

### Community 36 - "Community 36"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 08: Preview Console, Frontend Track, Validation Track

### Community 37 - "Community 37"
Cohesion: 0.5
Nodes (3): Development Handoff Stories, Handoff Spec, Implementation Order

### Community 38 - "Community 38"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 01: Render Contract, Frontend Track, Validation Track

### Community 39 - "Community 39"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 12: Spectroid Chase Shader, Frontend Track, Validation Track

### Community 40 - "Community 40"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 02: Analysis IR, Frontend Track, Validation Track

### Community 41 - "Community 41"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 06: Timeline Director, Frontend Track, Validation Track

### Community 42 - "Community 42"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 03: Preset Schema, Frontend Track, Validation Track

### Community 43 - "Community 43"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 05: Modulation System, Frontend Track, Validation Track

### Community 44 - "Community 44"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 07: Transition System, Frontend Track, Validation Track

### Community 45 - "Community 45"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 04: Layer Library, Frontend Track, Validation Track

### Community 46 - "Community 46"
Cohesion: 0.5
Nodes (4): Backend Track, Epic 09: Render Diagnostics, Frontend Track, Validation Track
...
## Knowledge Gaps
- **254 isolated node(s):** `FrameData`, `PresetParameter`, `ModulatorConfig`, `TransitionSchema`, `SceneSchema` (+249 more)
...
- **Why does `FrameRenderer` connect `Community 0` to `Community 1`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `FrameContext` connect `Community 1` to `Community 0`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Development Handoff Stories` connect `Community 37` to `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Are the 8 inferred relationships involving `FrameRenderer` (e.g. with `GenerateRequest` and `AudioAnalyzer`) actually correct?**
  _`FrameRenderer` has 8 INFERRED edges - model-reasoned connections that need verification._
